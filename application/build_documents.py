...
('body', 'Mobile engineer and tech lead with 5+ years of experience across Flutter, native iOS, and production application delivery. Hands-on experience with Swift, UIKit, iOS concurrency, secure API integrations, and App Store workflows. Contributed to a UK healthcare application serving NHS patients and currently lead Carbee’s Flutter Web team while supporting mobile delivery. Apply AI-agent-assisted and spec-driven development across planning, implementation, testing, and review.'),
...
('body', 'I’m applying for your remote Mobile Engineer position. I bring 5+ years of mobile development experience, combining Flutter delivery for Android and iOS with native iOS work in Swift and UIKit. Your focus on reliable mobile applications and AI-powered experiences is closely aligned with the products I have worked on and the engineering practices I use today.'),
